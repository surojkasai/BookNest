          ...
          children: [
              ...
              child: RichText(
                text: TextSpan(
                  ...
                  children: <TextSpan>[
                    ...
                    TextSpan(
                      text: 'Discover Our Best Selling!', // Engaging subtitle
                      style: TextStyle(
                        fontSize: 20,
                        color: Theme.of(context).textTheme.bodyLarge?.color,
                      ),
            ...
            ValueListenableBuilder<Box<Book>>(
              ...
              builder: (context, box, _) {
                ...
                bestSellingBooks.sort((a, b) => b.createdAt.compareTo(a.createdAt));
                ...
                return HorizontalBookList(
                  ...
                  books: bestSellingBooks, // Pass the List<Book> fetched from Hive
                );
              },
            ),
          ],
